...
namespace MyCookBookApp.Controllers
{
    ...
    public class RecipeController : Controller
    {
        ...
        {
            if (recipe == null || string.IsNullOrWhiteSpace(recipe.Name) || recipe.Ingredients == null || recipe.Ingredients.Count == 0 || recipe.Instructions == null || recipe.Instructions.Count == 0 || string.IsNullOrWhiteSpace(recipe.Summary) || recipe.Categories == null)
            {
                return BadRequest(new { success = false, message = "Invalid recipe data" });
            }
